...
echo "Direct IP: localhost:8080"
echo "Testing HTTP (port 80):"
timeout 10 curl -I http://localhost:8080 2>&1 || echo "❌ HTTP connection failed"
echo ""
echo "Testing custom port 8080:"
timeout 10 curl -I http://localhost:8080:8080 2>&1 || echo "❌ Port 8080 connection failed"
echo ""
echo "Testing ping:"
timeout 5 ping -c 3 localhost:8080 || echo "❌ Ping failed"
echo ""
